...
export const LogTemplates = {
  ...
  ACTIVITY_RECALCULATE_START: 'Activity[user_id={userId}] recalculate emissions start for region={newRegion}',
  ACTIVITY_RECALCULATE_SKIP: 'Activity[user_id={userId}] recalculate emissions skip: {reason}',
  ACTIVITY_RECALCULATE_SUCCESS: 'Activity[user_id={userId}] recalculate emissions success updated={updatedCount} total={total}',
